...
export const Marketplace: React.FC = () => {
  ...
  const addToCart = async (product: any) => {
    ...
    try {
      ...
      handleFirestoreError(error, OperationType.CREATE, 'cart');
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto space-y-4">
                      <div className="flex items-center justify-between text-[10px] font-bold text-gray-400 border-t border-gray-50 pt-4">
                          ...
                          <div className="flex items-center gap-1">
                            <div className="flex text-yellow-400">
                              {[...Array(5)].map((_, i) => (
                                <Star 
                                  key={i} 
                                  className={`w-2 h-2 ${i < Math.floor(product.farmerRating || 0) ? 'fill-current' : 'text-gray-300'}`} 
                                />
                              ))}
                            </div>
                            <span className="text-[8px] text-gray-400">({product.farmerReviewCount || 0})</span>
                          </div>
                        </div>
